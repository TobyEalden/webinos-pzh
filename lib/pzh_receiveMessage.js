...
var PzhReceiveMessage = function(){
    ...
    this.handleData = function (conn, buffer) {
        try {
            ...
            wUtil.webinosMsgProcessing.readJson (PzhObject.getSessionId() + conn.remoteAddress + conn.remotePort, buffer, function (obj) {
                                    ...
                                    var msg = {"type"        :"JSONRPC",
                                               ...
                                               "payload":{"jsonrpc":"2.0",
                                                          ...
                                                          "error":{name: "NetworkError",
                                                                   "code":19 ,
                                                                   "message":"Host " + validMsgObj.to + " is unreachable"}}
                                    };
