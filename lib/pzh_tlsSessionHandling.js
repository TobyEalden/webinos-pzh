        ...
        try {
            ...
            if (config.trustedList.pzp.hasOwnProperty (pzpId)) {
                ...
                process.nextTick(function() {
                  ...
                  PzhObject.trackEntity(pzpId);
                  PzhObject.addAction("connectedDevices","connectedPZP",{ id: pzpId });
                });
            } else {
            ...
            if (!pzh_state.connectedPzh.hasOwnProperty(pzhId)) {
               ...
               // PzhObject.registerServices(pzhId);
                ...
                process.nextTick(function() {
                  ...
                  PzhObject.trackEntity(pzhId);
                  PzhObject.addAction("connectedDevices","connectedPZH",{ id: pzhId });
                });
            } else {
